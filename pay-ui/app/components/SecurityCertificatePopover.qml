...
Popover {
    ...
    Column {
        ...
        Column {
            ...
            Row {
                ...
                Label {
                    ...
                    text: i18n.dtr("webbrowser-app", "This site has insecure content")
                    fontSize: "x-small"
                }
            }
        ...
        Label {
            width: parent.width
            wrapMode: Text.WordWrap
            text: i18n.dtr("webbrowser-app", "You are connected to")
            fontSize: "x-small"
        }
        ...
        Label {
            ...
            text: i18n.dtr("webbrowser-app", "Which is run by")
            fontSize: "x-small"
        }
